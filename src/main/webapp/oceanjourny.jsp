...
<body>
        ...
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-links">
                    ...
                    <li><a class="txt"  href="#destinations">Destinations</a></li>
                    <li><a class="txt"  href="#gallary">Gallary</a></li>
                    <li><a class="txt"  href="#about">About</a></li>
                    <li><a class="txt"  href="#contact">Contact</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <main>
            ...
            <section id="home" class="section">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
                   ...
                   <%String message = (String) request.getAttribute("message");
				    ...
				    <%} %>  
                  <div class="btn">
                    <button style="font-size: 26px;"><a href="userlogin.jsp" style="text-decoration: none">
                        Login To Ocean</a>
                        <div class="icon-1">
                          <svg
                  ...
                  <div class="white"></div>
                                        <div class="home_card">
                        <!-- <img id="sand" src="images/sand.jpg" alt=""> -->
                        <img id="boat" class="boat" src="images/boat.png" alt="boat">

                        <h1 id="home_h2" >"Sail into adventure with Ocean Journey. Where every wave leads to new discoveries."</h1>
                        <img id="shell" src="images/shell1.png" alt="">
                        <!-- <img id="sea" src="images/sea.png" alt="sea"> -->
                        <div   class="white2"></div>



                  </div><div class="white"></div>
                <!-- <h2>Welcome to Ocean Journey</h2> -->
                <!-- Add more content for the home section here -->
            </section>
        ...
        <section id="destinations" class="section">
            <h2 id="dest" class="dest">Our Destinations</h2>
                <img id="ele1" src="images/ele1.svg" alt="">
                <img id="ele2" src="images/ele2.webp" alt="">
            <section class="articles">
                <article>
                  <div class="article-wrapper" id="card1">
                    <figure>
                      <img class="desti" src="images/goa.jpg" alt="" />
                    </figure>
                    <div class="article-body">
                      <h2>GOA</h2>
                      <p>
                        Explore the exotic charm of Goa, a coastal paradise nestled along the Arabian Sea. Known for its golden beaches, vibrant culture, and Portuguese heritage, Goa offers a unique blend of relaxation and adventure.   </p>
                ...
                <article>
                  ...
                  <div class="article-wrapper" id="card2">
                    <figure>
                      <img src="images/med.jpg" alt="" />
                    </figure>
                    <div class="article-body">
                      <h2>Mediterranean Coast</h2>
                      <p>
                        Experience the charm and beauty of the Mediterranean coast as you cruise along ancient ports and picturesque 
                        landscapes. From the historic cities of Italy and Greece to the sun-kissed shores of the French Riviera and the
                         enchanting islands of Croatia</p>
                      <a href="#" class="read-more">
                        Read more <span class="sr-only">about this is some title</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 20 20" fill="currentColor">
                          <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                ...
                <article>
                  ...
                  <div class="article-wrapper" id="card3">
                    <figure>
                      <img src="images/alaska.jpg" alt="" />
                    </figure>
                    <div class="article-body">
                      <h2>Alaska's Inside Passage:</h2>
                      <p> Journey through Alaska's Inside Passage and witness the awe-inspiring beauty of towering glaciers, 
                        rugged mountains, and abundant wildlife. Cruise past fjords and pristine wilderness areas, visit quaint
                         coastal towns
                         </p>
                      <a href="#" class="read-more">
                        Read more <span class="sr-only">about this is some title</span>
            ...
            <!-- Add content for the offers section here -->
        </section>

        <section id="gallary" class="section">
            <h2 id="gallary_text">Gallary</h2>
            <img id="arrow" src="images/arrow.svg" alt="">
            <img id="ph" src="images/photo.webp" alt="">
            <div class="images">
		...
		<p style="margin-top: 200px;">
		  ...
		  <p style="margin-top: 0px;">
		    ...
		    <img src="images/photo3.jpg">
		            ...
		            <!-- Add content for the destinations section here -->
		        </section>
		
		        <section id="about" class="section">
		       
		          <h2 id="gallary_text">About Us</h2>
		<img src="images/shell1.png" alt="" id="s1">
		<img src="images/shell2.png" alt="" id="s2">
		          <img id="abt" src="images/about us.png" alt="">
		
		          <h3 id="abt_txt">Welcome to Ocean Journey, your gateway to unforgettable cruise adventures around the world. At Ocean Journey, we believe in the transformative power of travel and the magic of exploring the open seas. Our mission is to provide exceptional cruise experiences that inspire, delight, and create lifelong memories for our passengers.
		
		            With years of expertise in the travel industry, our team is dedicated to crafting tailor-made cruise packages that cater to every taste and preference. Whether you're dreaming of a luxurious Caribbean getaway, an adventurous expedition to Alaska, or a cultural exploration of the Mediterranean coast, we have the perfect voyage for you.
		            
		            At Ocean Journey, we go beyond simply booking cruises </h3> 
        ...
        <section id="contact" class="section contact-section">
            <div class="container">
                <h2 id="gallary_text" style="margin-bottom: 50px; color: #000;">Contact Us</h2>
                <form id="contact-form" action="contact" method="POST">
                    <div class="input-group">
                        <input type="text" id="name" name="name" placeholder="Your Name" required>
                    </div>
                    <div class="input-group">
                        <input type="tel" id="phone" name="contactno" placeholder="Your Phone Number" required>
                    </div>
                    <div class="input-group">
...
// ScrollReveal().reveal('.nav-links', {interval:16, delay: 700, orogin:'bottom'});
// ScrollReveal().reveal('.logoi', {interval:16, delay: 700, orogin:'bottom'});
ScrollReveal().reveal('#carouselExampleControls', {interval:16, delay: 500});
ScrollReveal().reveal('.btn', {interval:16, delay: 700,origin:'bottom'});
ScrollReveal().reveal('.boat', {interval:16, delay: 700});



ScrollReveal().reveal('.dest', {interval:16, delay: 300,origin:'bottom'});
ScrollReveal().reveal('#card1', {interval:16, delay: 700,origin:'left'});
ScrollReveal().reveal('#card2', {interval:16, delay: 700,origin:'bottom'});
ScrollReveal().reveal('#card3', {interval:16, delay: 700,origin:'right'});


ScrollReveal().reveal('#gallary_text', {interval:16, delay: 300,origin:'bottom'});
ScrollReveal().reveal('.images p ', {interval:16, delay: 700,origin:'bottom'});


ScrollReveal().reveal('#s1 ', {interval:16, delay: 700,origin:'bottom'});
ScrollReveal().reveal('#s2', {interval:16, delay: 700,origin:'bottom'});
ScrollReveal().reveal('#abt_txt', {interval:16, delay: 700});
ScrollReveal().reveal('#abt', {interval:16, delay: 700});
